...
class User {
    ...
    public function toJSON(){
        return '{"username":"'.$this->username.'","password":"'.$this->password.'","fname":"'.$this->fname.
                '","lname":"'.$this->lname.'","wins":"'.$this->wins.'","losses":"'.$this->losses.
                '","ties":"'.$this->ties.'","admin":"'.$this->admin.'"}';
    }
    ...
    public function updateSql(){
        ...
        $query = "UPDATE `entity_user` SET `username`= :u,`password`= :p,`first_name`= :fn,`last_name`= :ln,`wins`= :w,`losses`= :l,`ties`= :t,`admin`= :a WHERE `id_user` = :id";
        ...
        $statement->bindParam(":fn", $this->fname);
        $statement->bindParam(":ln", $this->lname);
        $statement->bindParam(":w", $this->wins);
        $statement->bindParam(":l", $this->losses);
        $statement->bindParam(":t", $this->ties);
        $statement->bindParam(":a", $this->admin);
    ...
    public function delFromSql(){
        //Connect to database
        require ('./dbconnect.php');
        
        $query = "DELETE FROM `entity_user` WHERE `id_user` = :id";
